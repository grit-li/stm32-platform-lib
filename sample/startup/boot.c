...
#elif defined(STM32_CLOCK_FREQ_80MHZ)
static const struct rcc_clock_scale_t rcc_clock_config_80mhz = {
    .lse = HZ(0),
    .lsi = KHZ(32),
    .msi = MHZ(48),
    .hsi = MHZ(16),
    ...
    .pll_clock = {
        .pll_source = rcc_pll_clock_source_hse,
        .pll_prescaler = rcc_clock_prescaler_1,
        .wait_cycle = rcc_clock_flash_wait_4ws,
        .pll_mul = rcc_clock_mul_20,
        .pllr_prescaler = rcc_clock_prescaler_2,
        .pllq_prescaler = rcc_clock_prescaler_2,
        .pllp_prescaler = rcc_clock_prescaler_7,
        .pllsai1_mul = rcc_clock_mul_8,
        .pllsai1r_prescaler = rcc_clock_prescaler_2,
        .pllsai1q_prescaler = rcc_clock_prescaler_2,
        .pllsai1p_prescaler = rcc_clock_prescaler_7,
        .pllsai2_mul = rcc_clock_mul_8,
        .pllsai2r_prescaler = rcc_clock_prescaler_2,
        .pllsai2q_prescaler = rcc_clock_prescaler_2,
        .pllsai2p_prescaler = rcc_clock_prescaler_7,
    },
    .rtc_clock = {
        .rtc_source = rcc_rtc_clock_source_lsi,
        .hse_prescaler = rcc_clock_prescaler_1,
    },
    .system_clock = {
        .system_clock_source = rcc_system_clock_source_pllclk,
        .ahb_prescaler = rcc_clock_prescaler_1,
        .apb1_prescaler = rcc_clock_prescaler_1,
        .apb2_prescaler = rcc_clock_prescaler_1,
        .cortex_system_prescaler = rcc_clock_prescaler_1,
        .apb1_timer_mul = rcc_clock_mul_1,
        .apb2_timer_mul = rcc_clock_mul_1,
    },
    .mco_clock = {
        .mco_source = rcc_mco_clock_source_sysclk,
