...
MSH_CMD_EXPORT_ALIAS(rt_pin_mode, "pinMode", "set hardware pin mode");
...
MSH_CMD_EXPORT_ALIAS(rt_pin_write, "pinWrite", "write value to hardware pin");
...
MSH_CMD_EXPORT_ALIAS(rt_pin_read, "pinRead", "read status from hardware pin");
