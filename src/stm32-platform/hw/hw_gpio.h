...
static inline struct GPIO_TypeDef* __GET_GPIOA_REGISTER__(void)
{
    return GPIOA;
}

static inline struct GPIO_TypeDef* __GET_GPIOB_REGISTER__(void)
{
    return GPIOB;
}

static inline struct GPIO_TypeDef* __GET_GPIOC_REGISTER__(void)
{
    return GPIOC;
}

static inline struct GPIO_TypeDef* __GET_GPIOD_REGISTER__(void)
{
    return GPIOD;
}

static inline struct GPIO_TypeDef* __GET_GPIOE_REGISTER__(void)
{
    return GPIOE;
}

static inline struct GPIO_TypeDef* __GET_GPIOF_REGISTER__(void)
{
    return GPIOF;
}

static inline struct GPIO_TypeDef* __GET_GPIOG_REGISTER__(void)
{
    return GPIOG;
}

static inline struct GPIO_TypeDef* __GET_GPIOH_REGISTER__(void)
{
    return GPIOH;
}

#define __GET_GPIO_REGISTER__(gpio) __GET_##gpio##_REGISTER__()
