...
void hw_rcc_set_msi_clock_ranges(uint32_t speed)
{
    switch(speed) {
        case 100000:    __BIT_COVER_SET__(__GET_RCC_CR__, RCC_CR_MSIRANGE, RCC_CR_MSIRANGE_0); break;
        case 200000:    __BIT_COVER_SET__(__GET_RCC_CR__, RCC_CR_MSIRANGE, RCC_CR_MSIRANGE_1); break;
        case 400000:    __BIT_COVER_SET__(__GET_RCC_CR__, RCC_CR_MSIRANGE, RCC_CR_MSIRANGE_2); break;
        case 800000:    __BIT_COVER_SET__(__GET_RCC_CR__, RCC_CR_MSIRANGE, RCC_CR_MSIRANGE_3); break;
        case 1000000:   __BIT_COVER_SET__(__GET_RCC_CR__, RCC_CR_MSIRANGE, RCC_CR_MSIRANGE_4); break;
        case 2000000:   __BIT_COVER_SET__(__GET_RCC_CR__, RCC_CR_MSIRANGE, RCC_CR_MSIRANGE_5); break;
        case 4000000:   __BIT_COVER_SET__(__GET_RCC_CR__, RCC_CR_MSIRANGE, RCC_CR_MSIRANGE_6); break;
        case 8000000:   __BIT_COVER_SET__(__GET_RCC_CR__, RCC_CR_MSIRANGE, RCC_CR_MSIRANGE_7); break;
        case 16000000:  __BIT_COVER_SET__(__GET_RCC_CR__, RCC_CR_MSIRANGE, RCC_CR_MSIRANGE_8); break;
        case 24000000:  __BIT_COVER_SET__(__GET_RCC_CR__, RCC_CR_MSIRANGE, RCC_CR_MSIRANGE_9); break;
        case 32000000:  __BIT_COVER_SET__(__GET_RCC_CR__, RCC_CR_MSIRANGE, RCC_CR_MSIRANGE_10); break;
        case 48000000:  __BIT_COVER_SET__(__GET_RCC_CR__, RCC_CR_MSIRANGE, RCC_CR_MSIRANGE_11); break;
    }
}
...
void hw_rcc_select_system_clock_source(uint32_t source)
{
...
uint32_t hw_rcc_set_pll_clock_source(enum hw_rcc_pll_clock_source_e source)
{
    switch(source) {
        case hw_rcc_pll_clock_source_msi:
            hw_rcc_set_main_clock_source(RCC_PLLCFGR_PLLSRC_MSI);
            break;
        case hw_rcc_pll_clock_source_hsi:
            hw_rcc_set_main_clock_source(RCC_PLLCFGR_PLLSRC_HSI);
            break;
        case hw_rcc_pll_clock_source_hse:
            hw_rcc_set_main_clock_source(RCC_PLLCFGR_PLLSRC_HSE);
            break;
    }
    return stm32_errcode_success;
}
uint32_t hw_rcc_set_pll_division_factor(uint32_t prescaler)
{
    switch (prescaler) {
        case 1: hw_rcc_set_division_factor_for_main_pll(0 << RCC_PLLCFGR_PLLM_Pos); break;
        case 2: hw_rcc_set_division_factor_for_main_pll(1 << RCC_PLLCFGR_PLLM_Pos); break;
        case 3: hw_rcc_set_division_factor_for_main_pll(2 << RCC_PLLCFGR_PLLM_Pos); break;
        case 4: hw_rcc_set_division_factor_for_main_pll(3 << RCC_PLLCFGR_PLLM_Pos); break;
        case 5: hw_rcc_set_division_factor_for_main_pll(4 << RCC_PLLCFGR_PLLM_Pos); break;
        case 6: hw_rcc_set_division_factor_for_main_pll(5 << RCC_PLLCFGR_PLLM_Pos); break;
        case 7: hw_rcc_set_division_factor_for_main_pll(6 << RCC_PLLCFGR_PLLM_Pos); break;
        case 8: hw_rcc_set_division_factor_for_main_pll(7 << RCC_PLLCFGR_PLLM_Pos); break;
    }
    return stm32_errcode_success;
}
uint32_t hw_rcc_set_pll_multiplication_factor(uint32_t mul)
{
    hw_rcc_set_multiplication_factor_for_main_pll(mul << RCC_PLLCFGR_PLLN_Pos);
    return stm32_errcode_success;
}
uint32_t hw_rcc_set_pllr_division_factor(uint32_t prescaler)
{
    switch(prescaler) {
        case 2: hw_rcc_set_main_pll_division_factor_for_pllclk(RCC_PLLCFGR_PLLR_0); break;
        case 4: hw_rcc_set_main_pll_division_factor_for_pllclk(RCC_PLLCFGR_PLLR_1); break;
        case 6: hw_rcc_set_main_pll_division_factor_for_pllclk(RCC_PLLCFGR_PLLR_2); break;
        case 8: hw_rcc_set_main_pll_division_factor_for_pllclk(RCC_PLLCFGR_PLLR_3); break;
    }
    return stm32_errcode_success;
}
uint32_t hw_rcc_set_system_clock_source(uint32_t source)
{
    switch(source) {
        case 0:
            hw_rcc_select_system_clock_source(RCC_CFGR_SW_MSI);
            break;
        case 1:
...
static void hw_rcc_set_clock_freq(enum hw_rcc_clock_source_e source, uint32_t freq)
{
    switch(source) {
        ...
        case hw_rcc_clock_source_msi:
            hw_rcc_set_msi_clock_ranges(freq);
...
static void hw_rcc_set_clock_enable(enum hw_rcc_clock_source_e source, enum hw_rcc_clock_enable_e en)
{
    switch(source) {
        ...
        case hw_rcc_clock_source_lsi:
            ...
            break;
        case hw_rcc_clock_source_msi:
            en == hw_rcc_clock_enable ? hw_rcc_set_msi_clock_enable() : hw_rcc_set_msi_clock_disable();
            break;
        case hw_rcc_clock_source_hsi:
...
static void hw_rcc_set_peripheral_clock_enable(enum hw_rcc_peripheral_clock_enable_e source, enum hw_rcc_clock_enable_e en)
{
    switch(source) {
        ...
        case hw_rcc_peripheral_clock_gpiog:
            ...
            break;
        case hw_rcc_peripheral_clock_gpioh:
            en == hw_rcc_clock_enable ? hw_rcc_set_gpioh_clock_enable() : hw_rcc_set_gpioh_clock_disable();
            break;
        default:
            break;
    }
    ...
    switch(type) {
        ...
        case HW_RCC_CMD_SET_PLL_CLOCK_SOURCE:
            if(wParam == hw_rcc_pll_clock_source_hse) {
                hw_rcc_set_main_clock_source(RCC_PLLCFGR_PLLSRC_HSE);
            } else if(wParam == hw_rcc_pll_clock_source_msi) {
                hw_rcc_set_main_clock_source(RCC_PLLCFGR_PLLSRC_MSI);
        ...
        case HW_RCC_CMD_SET_SYSTEM_CLOCK_SOURCE:
            if(wParam == hw_rcc_system_clock_source_msi) {
                hw_rcc_select_system_clock_source(RCC_CFGR_SW_MSI);
            } else if(wParam == hw_rcc_system_clock_source_hsi) {
                hw_rcc_select_system_clock_source(RCC_CFGR_SW_HSI);
        ...
        case HW_RCC_CMD_SET_USART_CLOCK_SOURCE:
            if(wParam == hw_rcc_usart_clock_source_pclk2) {
                hw_rcc_select_usart1_clock_source(RCC_CCIPR_USART1SEL_0);
            } else if(wParam == hw_rcc_usart_clock_source_sysclk) {
                hw_rcc_select_usart1_clock_source(RCC_CCIPR_USART1SEL_1);
            }
            /*
            else if(wParam == hw_rcc_usart_clock_source_pclk2) {
                hw_rcc_select_system_clock_source(RCC_CFGR_SW_HSE);
            } else if(wParam == hw_rcc_usart_clock_source_pclk2) {
                hw_rcc_select_system_clock_source(RCC_CFGR_SW_PLL);
            }
        ...
        case HW_RCC_CMD_SET_PRESCALER:
            if(wParam == hw_rcc_prescaler_clock_pll) {
                hw_rcc_set_pll_division_factor(lParam);
            } else if(wParam == hw_rcc_prescaler_clock_pllr) {
                hw_rcc_set_pllr_division_factor(lParam);
            }
            break;
